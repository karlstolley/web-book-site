...
$('div#content a[href^=http<strong>\\:\\/\\/</strong>]').addClass('ext');</pre>
        ...
        <li><strong>Page 244</strong>: The CSS style declaration at the bottom of the page should  refer to <code>margin-right</strong>. Here is the corrected version, with the correction highlighted:
